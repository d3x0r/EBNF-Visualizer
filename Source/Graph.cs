...
public class Node {
	...
	public static string[] nTyp =
		{"    ", "t   ", "nt  ", "eps ", "alt ", "iter", "opt ","reru", "wrap"};
	...
	public static void drawComponent(Symbol s, Graphics vg)	{
		if(s!=null)	{
			Node.#symbolSize=new Size(s.graph.graphSize.Width+beginningXCoordinate+componentGapWidth*2,s.graph.graphSize.Height+beginningYCoordinate+componentGapHeight*2+5);
